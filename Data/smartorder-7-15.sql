...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='行为日志表' AUTO_INCREMENT=164 ;
...
(19, '2015-07-24', '早饭', '', 0, '', 1, '', '0000-00-00 00:00:00', 0),
...
(25, '2015-07-16', '午饭', '孙增旺', 4, '13376542478', 11, '235', '0000-00-00 00:00:00', 0),
...
(1, 'admin', 0, '0000-00-00', '', 110, 53, 0, 1432774307, 0, 1436767998, 1);
...
(74, '座位管理', 4, 0, 'Table/index', 0, '', '座位设置', 0, 1),
...
CREATE TABLE IF NOT EXISTS `so_table` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='UUID和TableID对应表' AUTO_INCREMENT=22 ;
...
(1, 'admin', '4a7364270ebba0a7472a2e076bc5bd4c', 'xqnssa@qq.com', '', 1432774307, 2130706433, 1436767998, 0, 1432774307, 1);
