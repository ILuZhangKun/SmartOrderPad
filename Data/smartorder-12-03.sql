...
--
-- Host: 127.0.0.1
-- Generation Time: 2015-12-03 14:34:02
-- 服务器版本： 5.6.21
-- PHP Version: 5.5.15
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='行为日志表' AUTO_INCREMENT=180 ;
...
('ServerIP', '192.168.1.173', '服务端IP地址'),
('synKey', 'qqq', ''),
('SynVersion', '1449129794', 'Val存放时间戳，用户与前台同步'),
...
(1, 2, 3, '水煮鱼', '水煮鱼又称江水煮江鱼，是一道重庆市的汉族创新名菜，属于重庆渝北风味。最早流行于重庆、四川等地。看似原始的做法，实际做工考究--选新鲜生猛活鱼，又充分发挥辣椒御寒、益气养血功效，烹调出来的肉质一点也不会变韧，口感滑嫩，油而不腻。既去除了鱼的腥味，又保持了鱼的鲜嫩。满目的辣椒红亮养眼，辣而不燥，麻而不苦。“麻上头，辣过瘾”，让水煮鱼在全国流 行。', '48', '盘', '推荐', '/SmartOrder/Data/Uploads/Images/565ff6c9017e1.jpg', 0, 1449129673),
(2, 3, 2, '回锅肉', '川菜里的回锅肉，是我比较喜欢的一个菜，去十家菜馆，有十种做法，味道各有特色。据说四川人家家都得会做回锅肉，作为一道传统的川菜，可见它的地位非同一般。今天我也来做一下这道经典的川菜，用的是传统的做法。', '45', '盘', '普通', '/SmartOrder/Data/Uploads/Images/552338dddbefe.png', 0, 1444551377),
...
(16, 36, 2, '老醋花生', '是的发送到发送到收费的丰盛的防守打法', '20', '盘', '推荐', '/SmartOrder/Data/Uploads/Images/565ff71e24485.png', 0, 1449129934);
...
(1, 'admin', 0, '0000-00-00', '', 200, 64, 0, 1432774307, 2130706433, 1449129577, 1);
...
(1, 'admin', '4a7364270ebba0a7472a2e076bc5bd4c', 'xqnssa@qq.com', '', 1432774307, 2130706433, 1449129577, 2130706433, 1432774307, 1);
...
--
ALTER TABLE `so_action_log`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',AUTO_INCREMENT=180;
--
...
--
ALTER TABLE `so_cookmenu`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '菜名ID',AUTO_INCREMENT=17;
--
...
--
ALTER TABLE `so_order`
MODIFY `oid` int(10) NOT NULL AUTO_INCREMENT COMMENT '自增ID',AUTO_INCREMENT=2;
--
...
--
-- AUTO_INCREMENT for table `so_test`
--
ALTER TABLE `so_test`
