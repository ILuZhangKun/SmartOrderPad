...
//		this.sqlAdCreate='CREATE TABLE IF NOT EXISTS ads(adnum, starttime, endtime ,adname, adtext, adremark, adpic, adhref, adtitle, adtype, adshowcount, introduction,activity, address, phone,vehicle,detail,is_delete)';
		...
		this.sqlAdInsert="INSERT INTO ads (adnum,starttime,endtime,adname,adtext,adremark,adpic,adhref,adtitle,adtype,introduction,activity,phone,vehicle,is_delete,adverify_time,ad_hotel) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	saveAdDataToBase:function(data){
		console.log("AD执行了么？？");
		console.log(data);
		/*数据库字段增减：去掉adshowcount，address,detail添加adverify_time,ad_hotel*/
//		var paramAdArr=[
