/*! Amaze UI v2.2.1 | by Amaze UI Team | (c) 2015 AllMobilize, Inc. | Licensed under MIT | 2015-01-29T06:01:38 UTC */ ! function t(e, i, n) {
    function o(a, r) {
        if (!i[a]) {
            if (!e[a]) {
            ...
            function n() {
                ...
                t.each(function(t, i) {
                    ...
                    a.on("click.accordion.amui", function() {
                        ...
                        s.toggleClass("am-active"), a ? t.collapse("toggle") : t.collapse(), !n.multiple && o(i).children(".am-active").not(s).removeClass("am-active").find(e.body + ".am-in").collapse("close")
                    })
                })
            }
    ...
    4: [function(t, e) {
        (function(t) {
            ...
            var n = i.AMUI || {},
                ...
                s = window.document,
                a = i("html");
            n.VERSION = "2.0.0", n.support = {}, n.support.transition = function() {
                var t = function() {
                ...
                n.DOMWatchers.push(t), n.DOMReady && (console.log("ready call"), t(document))
            }, n.DOMObserve = function(t, e, o) {
                var s = n.support.mutationobserver;
                s && (e = i.isPlainObject(e) ? e : {
                    childList: !0,
                    subtree: !0
                }, o = "function" == typeof o && o || function() {}, i(t).each(function() {
                    var t = this,
                        a = i(t);
                ...
                var t = i.AMUI.FastClick;
                t && t.attach(document.body)
    ...
    6: [function(t, e) {
        (function(i) {
            ...
            var o = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null;
            t("./core"), o(window).on("load", n), e.exports = o.AMUI.duoshuo = {
                VERSION: "2.0.1",
                init: n
            }
        }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
        ...
        (function(i) {
            ...
            function n() {
                o(".am-figure").each(function(t, e) {
                    var i = s.utils.parseOptions(o(e).attr("data-am-figure"));
                    if (i.pureview)
                        if ("auto" === i.pureview) {
                            var n = o.isImgZoomAble(o(e).find("img")[0]);
                            n && o(e).pureview()
                        } else o(e).addClass("am-figure-zoomable").pureview()
                })
            }
    ...
    9: [function(t, e) {
        (function(i) {
            ...
            function n() {
                ...
                t.each(function() {
                    var t = a.utils.parseOptions(s(this).attr("data-am-gallery"));
            ...
            function o(t) {
                var e = s("<li class='am-gallery-more'><a href=\"javascript:;\">更多 &gt;&gt;</a></li>");
    ...
    13: [function(t, e) {
        (function(i) {
            ...
            function n() {
                s(".am-list-news-one").each(function() {
                    o(s(this))
                })
            }
            ...
            function o(t) {
                ...
                e.children().length > 6 && (e.children().each(function(t) {
                    ...
                    e.children().show(), s(this).hide()
                })
            }
            var s = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null;
            t("./core"), s(function() {
                n()
            }), e.exports = s.AMUI.listNews = {
                VERSION: "3.0.2",
                init: n
            }
        }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
    ...
    14: [function(t, e) {
        (function(i) {
            ...
            s(document).on("ready", a), e.exports = s.AMUI.map = {
                VERSION: "2.0.2",
                init: a
            }
        }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
    ...
    15: [function(t, e) {
        (function(i) {
            ...
            var o = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null;
            t("./core"), o(window).on("load", n), e.exports = o.AMUI.mechat = {
                VERSION: "2.0.1",
                init: n
            }
        }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
            ...
            function n() {
                ...
                if (n.length) {
                    var l = o(window),
                        ...
                        f = 60,
                        m = 16,
                        v = d.filter("[data-am-navbar-share]"),
                        g = d.filter("[data-am-navbar-qrcode]"),
                        w = "am-active",
    ...
    18: [function(t, e) {
        (function(i) {
            "use strict";
            var n = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null;
            t("./core"), e.exports = n.AMUI.pagination = {
                VERSION: "3.0.1"
            }
        }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
    }, {
    ...
    20: [function(t, e) {
        (function(i) {
            ...
            var s = o.AMUI;
            o(document).on("ready", n), e.exports = o.AMUI.slider = {
                VERSION: "3.0.1",
                init: n
            }
        }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
    ...
    27: [function(t, e) {
        (function(i) {
            ...
            a.DEFAULTS = {
                ...
                var e = this;
                n(document).on("click.datepicker.amui", function(t) {
                ...
                this.$picker.hide(), n(window).off("resize.datepicker.amui", this.place), this.viewMode = this.startViewMode, this.showMode(), this.isInput || n(document).off("click.datepicker.amui", this.close), this.$element.trigger({
                ...
                m = m.end().find("span").removeClass("am-active"), f === e && m.eq(this.date.getMonth()).addClass("am-active"), p = "", e = 10 * parseInt(e / 10, 10);
                var v = this.$picker.find(".am-datepicker-years").find(".am-datepicker-select").text(e + "-" + (e + 9)).end().find("td");
                e -= 1;
                for (var g = -1; 11 > g; g++) p += '<span class="' + (-1 === g || 10 === g ? " am-datepicker-old" : "") + (f === e ? " am-active" : "") + '">' + e + "</span>", e += 1;
                v.html(p)
            }, a.prototype.click = function(t) {
                t.stopPropagation(), t.preventDefault();
                var e, i, o = n(t.target).closest("span, td, th");
                    ...
                    case "th":
                        switch (o[0].className) {
                            ...
                            case "am-datepicker-next":
                                this.viewDate["set" + r.modes[this.viewMode].navFnc].call(this.viewDate, this.viewDate["get" + r.modes[this.viewMode].navFnc].call(this.viewDate) + r.modes[this.viewMode].navStep * ("am-datepicker-prev" === o[0].className ? -1 : 1)), this.fill(), this.set()
                        }
                        break;
                    case "span":
                        o.is(".am-datepicker-month") ? (e = o.parent().find("span").index(o), this.viewDate.setMonth(e)) : (i = parseInt(o.text(), 10) || 0, this.viewDate.setFullYear(i)), 0 !== this.viewMode && (this.date = new Date(this.viewDate), this.$element.trigger({
                        ...
                        break;
                    case "td":
                        if (o.is(".am-datepicker-day") && !o.is(".am-disabled")) {
                            var s = parseInt(o.text(), 10) || 1;
                            e = this.viewDate.getMonth(), o.is(".am-datepicker-old") ? e -= 1 : o.is(".am-datepicker-new") && (e += 1), i = this.viewDate.getFullYear(), this.date = new Date(i, e, s, 0, 0, 0, 0), this.viewDate = new Date(i, e, Math.min(28, s), 0, 0, 0, 0), this.fill(), this.set(), this.$element.trigger({
                                type: "changeDate.datepicker.amui",
                                date: this.date,
                                viewMode: r.modes[this.viewMode].clsName
            ...
            }, n.fn.datepicker.Constructor = a, n(document).on("ready", function() {
                    ...
                    controlNav: {
                        ...
                        setupPaging: function() {
                            var t, e, o = "thumbnails" === i.vars.controlNav ? "control-thumbs" : "control-paging",
                                a = 1;
                            if (i.controlNavScaffold = n('<ol class="' + s + "control-nav " + s + o + '"></ol>'), i.pagingCount > 1)
        ...
        (function(i) {
            ...
            function n(t, e) {
                return this.each(function() {
                    var i = o(this),
                        n = i.data("amui.modal"),
                        s = o.extend({}, c.DEFAULTS, "object" == typeof t && t);
            ...
            c.DEFAULTS = {
                ...
                if (!this.active && this.$element.length) {
                    t && (this.relatedTarget = t), this.transitioning && (clearTimeout(e.transitionEndTimmer), e.transitionEndTimmer = null, e.trigger(i.transitionEnd).off(i.transitionEnd)), n && this.$element.show(), this.active = !0, e.trigger(o.Event("open.modal.amui", {
                        relatedTarget: t
                    })), a.open(e), e.show().redraw(), n || this.isActions || (s && (s = parseInt(s, 10), c.width = s + "px", c.marginLeft = -parseInt(s / 2) + "px"), r ? (r = parseInt(r, 10), c.marginTop = -parseInt(r / 2) + "px", this.$dialog.css({
                        height: r + "px"
                ...
                if (this.active) {
                    var e = this.$element,
                        i = this.options,
                        n = this.isPopup;
                    this.transitioning && (clearTimeout(e.transitionEndTimmer), e.transitionEndTimmer = null, e.trigger(i.transitionEnd).off(i.transitionEnd), a.close(e, !0)), this.$element.trigger(o.Event("close.modal.amui", {
                        relatedTarget: t
                ...
                }), this.options.closeViaDimmer && a.$element.on("click.dimmer.modal.amui", function() {
                    t.close()
            ...
            c.DEFAULTS = {
                ...
                if (e.length && !e.hasClass("am-active")) {
                    ...
                    l.addClass("am-offcanvas-bar-" + i), o = {
                        ...
                        height: r.height()
                    }).addClass("am-offcanvas-page"), "overlay" !== i && a.css({
                        "margin-left": l.outerWidth() * c
                    }).width(), n.css("margin-top", -1 * o.y), setTimeout(function() {
            ...
            r.DEFAULTS = {
                ...
                if (e && e.length) {
                    ...
                    e.css({
                        ...
                        left: "",
                        top: ""
                    }), r - g < d.top + g ? f = u.top - r - g : r < h - d.top - d.height ? (w = "bottom", f = u.top + c + s + g) : (w = "middle", f = c / 2 + u.top - n / 2), "top" === w || "bottom" === w ? (m = l / 2 + u.left - i / 2, v = m, 5 > m && (m = 5), m + i > p && (m = p - i - 20), "top" === w && e.addClass("am-popover-top"), "bottom" === w && e.addClass("am-popover-bottom"), v -= m, o.css({
                        left: i / 2 - s + v + "px"
                    })) : "middle" === w && (m = u.left - i - s, e.addClass("am-popover-left"), 5 > m && (m = u.left + l + s, e.removeClass("am-popover-left").addClass("am-popover-right")), m + i > p && (m = p - i - 5, e.removeClass("am-popover-left").addClass("am-popover-right")), o.css({
                        top: n / 2 - s / 2 + "px"
                    })), e.css({
                        top: f + "px",
                        left: m + "px"
            ...
            var n = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null,
                o = (t("./core"), function() {
                    ...
                    o.configure = function(t) {
                        ...
                        var r, c = i.querySelector(a.barSelector),
        ...
        (function(i) {
            ...
            u.DEFAULTS = {
                ...
                this.refreshSlides(), o("body").append(n), this.$title = n.find(e.selector.title), this.$current = n.find(e.selector.current), this.$bar = n.find(e.selector.bar), this.$actions = n.find(e.selector.actions), e.shareBtn && this.$actions.append('<a href="javascript: void(0)" class="am-icon-share-square-o" data-am-toggle="share"></a>'), this.$element.on("click.pureview.amui", e.target, function(i) {
                    ...
                    childList: !0,
                    subtree: !0
                }, function() {}), i.on("changed.dom.amui", function(e) {
                ...
                var t = this,
                    ...
                    a = this.$images,
                    r = a.length;
                this.$slider = i.find(e.selector.slider), this.$nav = i.find(e.selector.nav), this.imgUrls = [];
            ...
            a.DEFAULTS = {
                ...
                function t(t, e, o) {
                    n.push({
                        group: o,
                        index: t,
                        active: e.selected ? i.selectedClass : "",
                        text: e.text,
                        value: e.value
                    })
                }
                var e = this.$element,
                    ...
                    n = [],
                    a = e.find("optgroup");
                e.hide(), a.length ? a.each(function(e) {
                    n.push({
                        header: !0,
                        group: e + 1,
                        text: this.label
                    }), a.eq(e).find("option").each(function(i, n) {
                        t(i, n, e)
                    })
                ...
                var r = {
                    ...
                    multiple: e.get(0).multiple,
                    options: n,
                    searchBox: i.searchBox,
                    dropUp: i.dropUp
                };
                this.$selector = o(this.render(r)), this.$searchField = this.$selector.find(".am-selected-search input"), this.$hint = this.$selector.find(".am-selected-hint");
                var l = this.$selector.find(".am-selected-btn").css({
                        width: this.options.btnWidth
                    }),
                    c = [];
                i.btnSize && c.push("am-btn-" + i.btnSize), i.btnStyle && c.push("am-btn-" + i.btnStyle), l.addClass(c.join(" ")), this.$selector.dropdown({
                    justify: l
                ...
                var u = [],
                    d = e.attr("minchecked"),
                    h = e.attr("maxchecked");
                e[0].required && u.push("必选"), (d || h) && (d && u.push("至少选择 " + d + " 项"), h && u.push("至多选择 " + h + " 项")), this.$hint.text(u.join("，")), this.$element.after(this.$selector), this.dropdown = this.$selector.data("amui.dropdown"), this.$status = this.$selector.find(".am-selected-status"), this.getShadowOptions(), this.syncData(), this.bindEvents()
            }, a.prototype.render = function(t) {
                return s.template(this.options.tpl, t)
            }, a.prototype.getShadowOptions = function() {
                this.$shadowOptions = this.$selector.find(".am-selected-list li").not(".am-selected-list-header")
                ...
                this.$element.val() || n.push(i.noSelectedText), this.$status.text(n.join(", ")), this.$element.trigger("change")
            }, a.prototype.bindEvents = function() {
                var t = this,
                    e = s.utils.debounce(function(e) {
                        t.$shadowOptions.not(".am-selcted-list-header").hide().filter(':containsNC("' + e.target.value + '")').show()
                    }, 100);
                this.$shadowOptions.on("click", function() {
                    t.setChecked(this)
                }), this.$searchField.on("keyup.selected.amui", e), this.$selector.on("closed.dropdown.amui", function() {
    ...
    43: [function(t, e) {
        (function(i) {
            ...
            a.DEFAULTS = {
                ...
                if (!t) return !1;
                var e = this.$element,
                    i = o('<div class="am-sticky-placeholder"></div>').css({
        ...
        (function(i) {
            ...
            a.DEFAULTS = {
                ...
                return a.H5validation && s.support.formValidation ? !1 : (n.attr("novalidate", "novalidate"), o.each(a.H5inputType, function(e, i) {
                    ...
                    return "function" == typeof a.submit ? a.submit.call(i, t) : a.validateOnSubmit ? i.isFormValid() : void 0
                ...
                return "function" == typeof n.validate && (b = n.validate.call(this, g)), b ? o.when(b).always(function(t) {
                    T.call(e, t)
                }) : void T.call(this, g)
                ...
                c.each(function() {
                    var i = t.isValid(this);
                    a = !!i && a, r.push(o(this).data("validity")), i || (l = l.add(o(this), e))
                });
                var u = {
                    valid: a,
                    $invalidFields: l,
                ...
                return e.trigger("validated.form.validator.amui", u), u
            }, a.prototype.isFormValid = function() {
                var t = this.validateAll();
                return t.valid ? (this.$element.trigger("valid.validator.amui"), !0) : (t.$invalidFields.first().focus(), this.$element.trigger("invalid.validator.amui"), !1)
    ...
    48: [function(t, e) {
        (function(t) {
            ...
            var n = "undefined" != typeof window ? window.jQuery : "undefined" != typeof t ? t.jQuery : null,
                ...
                r = s && /OS ([6-9]|\d{2})_\d/.test(navigator.userAgent),
            ...
            i.prototype.needsClick = function(t) {
                ...
                if (this.cancelNextClick = !1, this.lastClickTime = t.timeStamp, i = this.trackingClickStart, this.trackingClick = !1, this.trackingClickStart = 0, r && (c = t.changedTouches[0], u = document.elementFromPoint(c.pageX - window.pageXOffset, c.pageY - window.pageYOffset) || u, u.fastClickScrollParent = this.targetElement.fastClickScrollParent), n = u.tagName.toLowerCase(), "label" === n) {
                ...
                return s && !a && (l = u.fastClickScrollParent, l && l.fastClickLastScrollTop !== l.scrollTop) ? !0 : (this.needsClick(u) || (t.preventDefault(), this.sendClick(u, t)), !1)
                ...
                return new i(t, e)
            }, n && (n.AMUI ? n.AMUI.FastClick = i : n.AMUI = {
                FastClick: i
            }), e.exports = i
        }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
    }, {}],
    49: [function(t, e) {
        (function(i) {
            "use strict";
            var n = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null,
                o = (t("./core"), "undefined" != typeof Element && "ALLOW_KEYBOARD_INPUT" in Element),
                s = function() {
                    for (var t, e, i = [
    ...
    51: [function(t, e) {
        (function(i) {
            ...
            function E(t) {
                ...
                return new(e = i ? i : ge ? _ : we ? R : ve ? W : z)(t, k)
            }
            ...
            function S(t, e) {
                ...
                var s = i.firstInput,
                    ...
                    l = e.center = M(n);
                e.timeStamp = pe(), e.deltaTime = e.timeStamp - s.timeStamp, e.angle = $(r, l), e.distance = N(r, l), A(i, e), e.offsetDirection = P(e.deltaX, e.deltaY), e.scale = a ? O(a.pointers, n) : 1, e.rotation = a ? L(a.pointers, n) : 0, D(i, e);
                var c = t.element;
            ...
            function D(t, e) {
                ...
                if (e.eventType != Ae && (r > Ce || void 0 === a.velocity)) {
                    var l = a.deltaX - e.deltaX,
                        c = a.deltaY - e.deltaY,
                        u = I(r, l, c);
                    n = u.x, o = u.y, i = he(u.x) > he(u.y) ? u.x : u.y, s = P(l, c), t.lastInterval = e
            ...
            function P(t, e) {
                return t === e ? De : he(t) >= he(e) ? t > 0 ? Fe : Me : e > 0 ? Ie : Pe
            }
            ...
            function z() {
                this.evEl = je, this.evWin = Ue, this.allow = !0, this.pressed = !1, C.apply(this, arguments)
            }
            ...
            function X(t) {
                return t == Pe ? "down" : t == Ie ? "up" : t == Fe ? "left" : t == Me ? "right" : ""
            }
            ...
            Q.prototype = {
                ...
                directionTest: function(t) {
                    var e = this.options,
                        ...
                        s = t.deltaX,
                        a = t.deltaY;
                    return o & e.direction || (e.direction & Ne ? (o = 0 === s ? De : 0 > s ? Fe : Me, i = s != this.pX, n = Math.abs(t.deltaX)) : (o = 0 === a ? De : 0 > a ? Ie : Pe, i = a != this.pY, n = Math.abs(t.deltaY))), t.direction = o, i && n > e.threshold && o & e.direction
                },
                attrTest: function(t) {
                ...
                process: function(t) {
                    ...
                    if (this._input = t, !o || !i || t.eventType & (Se | Ae) && !s) this.reset();
                    else if (t.eventType & Ee) this.reset(), this._timer = n(function() {
                        this.state = li, this.tryEmit()
                    }, e.time, this);
                    else if (t.eventType & Se) return li;
                    return ui
                },
                reset: function() {
        ...
        (function(i) {
            ...
            d.prototype.createDefault = function(t) {
                ...
                for (var e, i, n, o, s = t.getModuleCount(), a = this.options.height / this.options.width, r = '<svg xmlns="http://www.w3.org/2000/svg" width="' + this.options.width + 'px" height="' + this.options.height + 'px" viewbox="0 0 ' + 10 * s + " " + 10 * s * a + '">', l = "<path ", u = ' style="stroke-width:0.5;stroke:' + this.options.foreground + ";fill:" + this.options.foreground + ';"></path>', d = ' style="stroke-width:0.5;stroke:' + this.options.background + ";fill:" + this.options.background + ';"></path>', h = 0; s > h; h++)
                    for (var p = 0; s > p; p++) e = 10 * p, n = 10 * h * a, i = 10 * (p + 1), o = 10 * (h + 1) * a, r += l + 'd="M ' + e + "," + n + " L " + i + "," + n + " L " + i + "," + o + " L " + e + "," + o + ' Z"', r += t.modules[h][p] ? u : d;
                return r += "</svg>", c(r)[0]
            }, s.prototype = {
                constructor: s,
                    ...
                    for (var t = f.getPatternPosition(this.typeNumber), e = 0; e < t.length; e++)
                        for (var i = 0; i < t.length; i++) {
                            ...
                            if (null == this.modules[n][o])
                                for (var s = -2; 2 >= s; s++)
                                    for (var a = -2; 2 >= a; a++) this.modules[n + s][o + a] = -2 == s || 2 == s || -2 == a || 2 == a || 0 == s && 0 == a ? !0 : !1
                        }
                },
                ...
                createBytes: function(t) {
                    for (var e = 0, i = 0, n = 0, o = this.rsBlock.length / 3, s = new Array, r = 0; o > r; r++)
                        for (var l = this.rsBlock[3 * r + 0], c = this.rsBlock[3 * r + 1], u = this.rsBlock[3 * r + 2], d = 0; l > d; d++) s.push([u, c]);
                    ...
                    for (var x = new Array(this.totalDataCount), C = 0, r = 0; i > r; r++)
                        for (var m = 0; m < s.length; m++) r < h[m].length && (x[C++] = h[m][r]);
                    for (var r = 0; n > r; r++)
    ...
    53: [function(t, e) {
        (function(i) {
            ...
            var s, a = {},
                r = window,
                l = "localStorage";
            a.disabled = !1, a.version = "1.3.17", a.set = function() {}, a.get = function() {}, a.has = function(t) {
                return void 0 !== a.get(t)
            }, a.remove = function() {}, a.clear = function() {}, a.transact = function(t, e, i) {
    ...
    54: [function(t, e) {
        (function(i) {
            ...
            var o = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null,
                ...
                r = n;
            o(document).on("ready", r), e.exports = o.AMUI.pay = {
                VERSION: "1.0.0",
                init: r
            }
        }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
