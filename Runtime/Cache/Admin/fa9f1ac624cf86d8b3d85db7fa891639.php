...
<body>
    ...
    <div class="tab-wrap">
        <div class="main-title">
            ...
            <form action="<?php echo U('/MenuManage/addCookMenu','','');?>" method="post" class="form-horizontal">
                <div class="form-item">
                    <label class="item-label">选择菜系<span class="check-tips"></span></label>
                    <div class="controls">
                    <select name="styleid">
                        <?php if(is_array($CookStyle)): foreach($CookStyle as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" ><?php echo ($v["stylename"]); ?></option><?php endforeach; endif; ?>      
                    </select>  
                    </div>
                </div>
                <div class="form-item">
