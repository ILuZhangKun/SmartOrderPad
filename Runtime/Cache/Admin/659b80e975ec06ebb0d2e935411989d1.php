...
<body>
    ...
    <div id="main-content">
        ...
        <form action="<?php echo U('/MenuManage/ModifyCookStyle','','');?>" method="post" class="form-horizontal">
            <div class="form-item">
                <label class="item-label">您要将"<b color= "red"><?php echo ($info["stylename"]); ?></b>"修改为：
                <span class="check-tips" style="display:none" name = "id" value = "1"></span>
                </label>
                <div class="controls">
                    <input type="text" class="text input-mid" name="stylename" value="<?php echo ($info["stylename"]); ?>"/>
                    <input type="text" class="text input-mid" style="display:none" name= "styleid" value = "<?php echo ($info["id"]); ?>">
                </div>
            </div>
