...
<body>
    ...
    <div id="main-content">
		...
		<tbody>
			<?php if(is_array($Ads_type)): foreach($Ads_type as $key=>$v): ?><tr>
					<td><?php echo ($v["typenum"]); ?></td>
					<td><?php echo ($v["typename"]); ?></td>
					<td><?php echo ($v["remark"]); ?></td>	
					<td><a href="<?php echo U('edit');?>?typenum=<?php echo ($v["typenum"]); ?>">编辑</a>|
						<a href="<?php echo U('del');?>?typenum=<?php echo ($v["typenum"]); ?>">删除</a>
					</td>
