...
<body>
	...
	<div class="data-table table-striped">
		...
		<table class="order-table">
			...
			<tbody>
				<?php if(is_array($order)): foreach($order as $key=>$v): if($v["id"] == 1): ?><td>
						...
						<!--<td>
								<?php if($v["is_pay"] == '1'): ?>已支付
								<?php else: ?>
									未支付<?php endif; ?>									
							</td>	-->
						<td><?php echo ($v["pay_type"]); ?></td>
						<td><?php echo ($v["pay_time"]); ?></td>
						<!--<td><button style="width: 40px;height: 25px;border: 0px;background-color: darkgreen;"><a href="<?php echo U('orderList');?>?oid=<?php echo ($v["oid"]); ?>&tid=<?php echo ($v["table_id"]); ?>" style="color: white;">结账</a></button>
		...
		<label style="font-size: 18px;margin-top: 3px;">迎宾厅</label>
		<table class="order-table">
			<thead>
				<tr>
					<!--<th>厅号</th>-->
		...
		<label style="font-size: 18px;margin-top: 3px;">清风厅</label>
		<table class="order-table">
			<thead>
				<tr>
					<!--<th>厅号</th>-->
		...
		<label style="font-size: 18px;margin-top: 3px;">复古厅</label>
		<table class="order-table">
			<thead>
				<tr>
					<!--<th>厅号</th>-->
		...
		<label style="font-size: 18px;margin-top: 3px;">怀旧厅</label>
		<table class="order-table">
			<thead>
				<tr>
					<!--<th>厅号</th>-->
