    ...
    <div id="main-content">
		...
		<div class="data-table table-striped">
			<table class="">
				...
				<tbody>
					<?php if(is_array($tableList)): foreach($tableList as $key=>$v): ?><tr>					
							<td><?php echo ($v["table_name"]); ?></td>
							<td><?php echo ($v["uuid"]); ?></td>	
							<td><?php echo ($v["is_lock"]); ?></td>	
							<td>
								<a href="<?php echo U('');?>?">预定</a>|
								<a href="<?php echo U('orderList');?>?tid=<?php echo ($v["id"]); ?>">结账</a>|
								<a href="<?php echo U('');?>?">其他</a>
							</td>
        ...
        <input type="button" class="cash-back" value="返回上一级" onclick="history.back();">
    </div>
</div>
<script>
