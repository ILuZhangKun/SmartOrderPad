    ...
    <div id="main-content">
		...
		<div class="data-table table-striped">
			<table class="">
				...
				<tbody>
					<?php if(is_array($book)): foreach($book as $key=>$v): ?><tr>					
							<td><?php echo ($v["id"]); ?></td>
							<td><?php echo ($v["book_day"]); ?></td>
							<td><?php echo ($v["book_time"]); ?></td>	
							<td><?php echo ($v["book_name"]); ?></td>	
							<td><?php echo ($v["book_num"]); ?></td>	
							<td><?php echo ($v["book_tel"]); ?></td>	
							<td><?php echo ($v["book_table"]); ?></td>	
							<td><?php echo ($v["book_demand"]); ?></td>	
							<td><?php echo ($v["book_deadline"]); ?></td>	
							<td>
								<?php if($v["book_status"] == '0'): ?>预约未到
								<?php elseif($v["book_status"] == '1'): ?>
									就餐未开始
								<?php elseif($v["book_status"] == '2'): ?>
									正在用餐
								<?php else: ?>
									预约超期<?php endif; ?>
							</td>
