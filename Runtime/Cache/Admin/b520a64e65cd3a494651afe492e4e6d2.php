...
<body>
    ...
    <div class="data-table table-striped">
        <table>
            ...
            <tbody>
                <?php if(is_array($CookMenu)): foreach($CookMenu as $key=>$v): ?><tr>
                <td><?php echo ($v["id"]); ?></td>
                ...
                <a href="<?php echo U('/MenuManage/ModifyCookMenu/MenuId/'.$id,'','');?>">修改</a> |
                <a href="<?php echo U('/MenuManage/DelCookMenu/id/'.$id,'','');?>">删除</a></td> 
                <td <?php echo ($cookname=$v["cookname"]); ?>> 
                <a href="<?php echo U('/MenuManage/upImage/id/'.$id,'','');?>">编辑图片</a>
                </td>
