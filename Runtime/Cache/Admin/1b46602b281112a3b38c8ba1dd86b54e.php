    ...
    <div id="main-content">
		...
		<div class="data-table table-striped">
			<table class="">
				...
				<tbody>
					<?php if(is_array($hall)): foreach($hall as $key=>$v): ?><tr>					
							<td><a href="<?php echo U('tableList');?>?hall_id=<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></a></td>
        ...
        <h1>呼叫服务列表</h1>
        <div class="data-table table-striped" id="holding">
        	<table class="">
        		<thead>
        			<tr>
        				<th>厅号</th>
        		...
        		<tbody>
        			<?php if(is_array($holdInfo)): foreach($holdInfo as $key=>$v): ?><tr>
        					<td><?php echo ($v["hall_name"]); ?></td>
        					<td><?php echo ($v["table_name"]); ?></td>
        					<td><?php echo ($v["holding"]); ?></td>
