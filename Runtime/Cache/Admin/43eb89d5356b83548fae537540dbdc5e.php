...
<body>
    ...
    <div id="main-content">
        ...
        <form action="<?php echo U('MenuManage/addCookStyle','','');?>" method="post" class="form-horizontal">
            <div class="form-item">
                <label class="item-label">类别名称<span class="check-tips"></span></label>
                <div class="controls">
                    <input type="text" class="text input-mid" name="stylename" value=""/>
                </div>
            </div>
