...
<body>
    ...
    <div id="main-content">
        ...
        <div class="main-title">
            <h2>您现在添加图片的菜名为：<?php echo ($info["cookname"]); ?></h2>
        </div>
        <div class="tab-wrap">
            <form action="<?php echo U('/MenuManage/upload','','');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                        <!-- 隐藏input用于存放的菜名ID -->
                        <input type="text"  name="id" style="display:none" value=<?php echo ($info["id"]); ?>>
                <?php if(info.picture != 'null'): ?><div class="form-item">
                <label class="item-label">图片<span class="check-tips"></span></label>
                    <div class="controls" style="hight:300px;width:300px;">
                ...
                <label class="item-label">上传图片<span class="check-tips"></span></label>
                    <div class="controls">
                        <input type="file" class="text input" name="cookname" value=""/>
                    </div>
                </div>
               <div class="form-item">
