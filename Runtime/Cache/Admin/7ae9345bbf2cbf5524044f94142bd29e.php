...
<body>
    ...
    <div id="main-content">
        ...
        <form action="<?php echo U("/UserManage/ModifyUser");?>" method="post" class="form-horizontal">
            <div class="form-item">
                ...
                <div class="controls">
                    ...
                    <input type="text" class="text input-large" name="id" style="display:none" value="<?php echo ($info["id"]); ?>">
            ...
            <div class="form-item">
                ...
                <div class="controls">
                    <input type="text" class="text input-large" name="WorkId" value="<?php echo ($info["workid"]); ?>">
                </div>
            </div>
            <div class="form-item">
                <label class="item-label">身份证号码<span class="check-tips"></span></label>
                <div class="controls">
                    <input type="text" class="text input-large" name="IdCardNum" value="<?php echo ($info["idcardnum"]); ?>">
                </div>
            </div>
            <div class="form-item">
            ...
            <div class="form-item">
                ...
                <div class="controls">
                <select name="Position" id="<?php echo ($posit=$info["Position"]); ?>">
                    <?php if(is_array($position)): foreach($position as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if(($v["id"] == $posit)): ?>selected="selected"<?php endif; ?>><?php echo ($v["position"]); ?></option><?php endforeach; endif; ?>      
                </select>  
                </div>
            </div>
            <div class="form-item">
