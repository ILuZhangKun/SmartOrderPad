...
<body>
	...
	<div class="data-table table-striped">
		<label style="font-size: 18px;margin-top: 3px;">富贵厅</label>
		<table class="order-table">
			...
			<tbody>
				<?php if(is_array($order)): foreach($order as $key=>$v): if($v["id"] == 1): ?><tr>
							<td>
								<!--<a href="<?php echo U('orderList');?>?oid=<?php echo ($v["oid"]); ?>&tid=<?php echo ($v["table_id"]); ?>"><?php echo ($v["table_id"]); ?></a>-->
								<p><?php echo ($v["table_name"]); ?></p>
							</td>
							<td><?php echo ($v["order_time"]); ?></td>
							<td><?php echo ($v["add_time"]); ?></td>
							<td><?php echo ($v["total_money"]); ?></td>
							<td>0</td>
							<td><div style="margin: 0 auto; width: 40px;line-height: 25px; height: 25px;border: 0px;background-color: darkgreen;"><a href="<?php echo U('orderList');?>?oid=<?php echo ($v["oid"]); ?>&tid=<?php echo ($v["table_id"]); ?>" style="color: white;">结账</a></div></td>
						</tr><?php endif; endforeach; endif; ?>
			</tbody>
		</table>
		<label style="font-size: 18px;">迎宾厅</label>
		<table class="order-table">
			<thead>
				<tr>
					<!--<th>厅号</th>-->
			...
			<tbody>
				<?php if(is_array($order)): foreach($order as $key=>$v): if($v["id"] == 2): ?><tr>
							<td>
								<!--<a href="<?php echo U('orderList');?>?oid=<?php echo ($v["oid"]); ?>&tid=<?php echo ($v["table_id"]); ?>"><?php echo ($v["table_id"]); ?></a>-->
								<p><?php echo ($v["table_name"]); ?></p>
							</td>
		...
		<label style="font-size: 18px;">清风厅</label>
		<table class="order-table">
			<thead>
				<tr>
					<!--<th>厅号</th>-->
			...
			<tbody>
				<?php if(is_array($order)): foreach($order as $key=>$v): if($v["id"] == 3): ?><tr>
							<td>
								<!--<a href="<?php echo U('orderList');?>?oid=<?php echo ($v["oid"]); ?>&tid=<?php echo ($v["table_id"]); ?>"><?php echo ($v["table_id"]); ?></a>-->
								<p><?php echo ($v["table_name"]); ?></p>
							</td>
							...
							<td><?php echo ($v["total_money"]); ?></td>
							<td>0</td>
							<td><div style="margin: 0 auto; width: 40px;line-height: 25px; height: 25px;border: 0px;background-color: darkgreen;"><a href="<?php echo U('orderList');?>?oid=<?php echo ($v["oid"]); ?>&tid=<?php echo ($v["table_id"]); ?>" style="color: white;">结账</a></div></button></td>
						</tr><?php endif; endforeach; endif; ?>
			</tbody>
		</table>
		<label style="font-size: 18px;">复古厅</label>
		<table class="order-table">
			<thead>
				<tr>
					<!--<th>厅号</th>-->
			...
			<tbody>
				<?php if(is_array($order)): foreach($order as $key=>$v): if($v["id"] == 4): ?><tr>
							<td>
								<!--<a href="<?php echo U('orderList');?>?oid=<?php echo ($v["oid"]); ?>&tid=<?php echo ($v["table_id"]); ?>"><?php echo ($v["table_id"]); ?></a>-->
								<p><?php echo ($v["table_name"]); ?></p>
							</td>
		...
		<label style="font-size: 18px;">怀旧厅</label>
		<table class="order-table">
			<thead>
				<tr>
					<!--<th>厅号</th>-->
			...
			<tbody>
				<?php if(is_array($order)): foreach($order as $key=>$v): if($v["id"] == 5): ?><tr>
							<td>
								<!--<a href="<?php echo U('orderList');?>?oid=<?php echo ($v["oid"]); ?>&tid=<?php echo ($v["table_id"]); ?>"><?php echo ($v["table_id"]); ?></a>-->
								<p><?php echo ($v["table_name"]); ?></p>
							</td>
